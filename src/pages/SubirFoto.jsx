    ...
    <div className="seleccionarImagen" data-testid="subirImagen">
      ...
      <div className="añadirImagen">
        ...
        <div className="divOpciones">
          <div className="subir">
            <span id="fileSpan">
              <MdUploadFile className="iconGrande" />
              Subir imagen
            </span>
            <input
              type="file"
          ...
          <button
            className="sacarFoto"
            onClick={() => eraseAndChange("camara")}
          >
            <BsCamera className="iconGrande" />
            Sacar foto
          </button>
        </div>
        ...
        <Button buttonSize="btn--medium" buttonStyle="btn--success--solid" icon={<FiCheck />} >Enviar</Button>
        <Button buttonSize="btn--medium" buttonStyle="btn--danger--solid" >Cancelar</Button>
      </div>
    </div>
  );
}
